...
The current workflow can support academic-style writing outputs such as:

- a Results paragraph draft
- a Discussion paragraph draft
- a limitations list
...
- IC50 fitting is available, but any fitted value should still be reviewed manually for data quality and model suitability.
